...
export class AddressComponent implements OnInit {
  ...
  cities={"北京市":["东城区","西城区","崇文区","宣武区","朝阳区","丰台区","石景山区","海淀区","门头沟区","房山区","通州区","顺义区","昌平区","大兴区","怀柔区","平谷区","密云县","延庆县","延庆镇"],
  ...
  address(){
    ...
    data.set("userAddressId",this.userId);
    this.UserService.findaddress(data,res=>
    {
      console.log(res.resultCode);
      this.user_address= res.address.addressProvince+"-"+res.address.addressCity+"-"+res.address.addressCounty;
    })
  }
  ...
  getValue() {
    ...
    var data = new FormData();
    data.set("addressId","1");
    data.set("addressProvince",this.selectedProvince);
    data.set("addressCity",this.selectedCity);
    data.set("addressCounty",this.selectedArea);
    this.UserService.upaddress(data,res=>
    {
      console.log(res);
      this.user_address= res.address.addressProvince+"-"+res.address.addressCity+"-"+res.address.addressCounty;
    })
